...
the_bugman2 = Entity(Game_object.defaultimagelist[0], Game_object.defaultimagelist, 600, 900)
the_bugman3 = Entity(Game_object.defaultimagelist[0], Game_object.defaultimagelist, 400, 700)
the_bugman4 = Entity(Game_object.defaultimagelist[0], Game_object.defaultimagelist, 300, 800)
